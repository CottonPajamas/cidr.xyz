/*
 * Credit for the code in this page is be given to the following contributor.  
 * GitHub link: https://github.com/rs/node-netmask
 * 
 * Coffeescript shared was then decaffeinated using this tool here:
...
class Netmask {
  constructor(net, mask) {
      ...
      if (!mask) {
          ...
          [net, mask] = Array.from(net.split('/', 2));
      }
      if (!mask) {
          mask = 32;
      }
